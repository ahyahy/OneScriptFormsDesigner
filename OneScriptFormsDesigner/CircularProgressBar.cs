...
{
    public class CircularProgressBar : System.Windows.Forms.UserControl
    {
        ...
        [Description("Возвращает или задает целочисленное значение, определяющее ход выполнения задачи.")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        [DisplayName("КонечныйЦвет")]
        [Description("Возвращает или задает конечный цвет индикатора.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        ...
        [Description("Возвращает или задает максимальное значение индикатора.")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        [Description("Возвращает или задает начальный цвет индикатора.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        [TypeConverter(typeof(MyColorConverter))]
        [Editor(typeof(MyColorEditor), typeof(UITypeEditor))]
        ...
        [DisplayName("ПоЧасовой")]
        [Description("Возвращает или задает направление продвижения индикатора.")]
        [Category("Поведение")]
        [Browsable(true)]
        [TypeConverter(typeof(MyBooleanConverter))]
        ...
        [Description("Возвращает или задает режим отображения текста в строке индикатора.")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        [DisplayName("Текст")]
        [Description("Возвращает или задает текст, отображаемый внутри элемента управления.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        public  string Text_osf
        {
            get { return _Text_osf; }
            set { _Text_osf = value; }
        }
        ...
        [Description("Возвращает или задает форму индикатора.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        public ProgressShape ProgressShape { get; set; }

        [DisplayName("ЦветКруга")]
        [Description("Возвращает или задает цвет внутри индикатора.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        [TypeConverter(typeof(MyColorConverter))]
        [Editor(typeof(MyColorEditor), typeof(UITypeEditor))]
        ...
        [Description("Возвращает или задает цвет промежуточной линии.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        [TypeConverter(typeof(MyColorConverter))]
        [Editor(typeof(MyColorEditor), typeof(UITypeEditor))]
        ...
        [Description("Возвращает или задает ширину промежуточной линии.")]
        [Category("Поведение")]
        [Browsable(true)]
        public int LineWidth { get; set; }

        [DisplayName("ШиринаПолосы")]
        [Description("Возвращает или задает ширину полосы индикатора.")]
        [Category("Поведение")]
        [Browsable(true)]
