...
namespace osfDesigner
{
    public class DataGridViewComboBoxColumn : System.Windows.Forms.DataGridViewComboBoxColumn
    {
        ...
        [Description("Возвращает или задает максимальное количество элементов в раскрывающемся списке ячеек в колонке.")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        [Description("Возвращает или задает значение, указывающее, сортируются ли элементы в поле со списком.")]
        [Category("Поведение")]
        [Browsable(true)]
        [TypeConverter(typeof(MyBooleanConverter))]
        ...
        [Description("Возвращает или задает плоский внешний вид для ячеек колонки.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        ...
        [DisplayName("СтильОтображения")]
        [Description("Возвращает или задает значение, которое определяет способ отображения поля со списком, когда оно не редактируется.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        public new DataGridViewComboBoxDisplayStyle DisplayStyle
        {
            get { return (DataGridViewComboBoxDisplayStyle)base.DisplayStyle; }
            set { base.DisplayStyle = (System.Windows.Forms.DataGridViewComboBoxDisplayStyle)value; }
        }
        ...
        [Description("Возвращает коллекцию объектов, используемую в полях со списками.")]
        [Category("Данные")]
        [Browsable(true)]
        [TypeConverter(typeof(MyCollectionConverter))]
        [Editor(typeof(MyDataGridViewComboBoxCollectionEditor), typeof(UITypeEditor))]
        public new System.Windows.Forms.DataGridViewComboBoxCell.ObjectCollection Items
        {
        ...
        [Browsable(false)]
        public new dynamic AutoComplete { get; set; }
        ...
        [Browsable(false)]
        public new dynamic DisplayStyleForCurrentCellOnly { get; set; }
        
        [Browsable(false)]
        public new dynamic DropDownWidth { get; set; }
