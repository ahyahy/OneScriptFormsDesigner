...
{
    public class DataGridViewImageColumn : System.Windows.Forms.DataGridViewImageColumn
    {
        ...
        [Description("Возвращает или задает строку, описывающую изображение колонки.")]
        ...
        [DisplayName("РазмещениеИзображения")]
        [Description("Возвращает или задает макет изображения в ячейках для данного элемента управления.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        public new DataGridViewImageCellLayout ImageLayout
        {
            get { return (DataGridViewImageCellLayout)base.ImageLayout; }
            set { base.ImageLayout = (System.Windows.Forms.DataGridViewImageCellLayout)value; }
        }
        ...
        [Browsable(false)]
        public new dynamic Image { get; set; }
