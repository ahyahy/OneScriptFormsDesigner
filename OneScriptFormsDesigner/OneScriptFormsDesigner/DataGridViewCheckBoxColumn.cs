...
{
    public class DataGridViewCheckBoxColumn : System.Windows.Forms.DataGridViewCheckBoxColumn
    {
        ...
        [Description("Возвращает или задает плоский внешний вид для ячеек флажков.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        ...
        [DisplayName("ТриСостояния")]
        [Description("Возвращает или задает значение, указывающее, допускают ли размещенные ячейки флажков три контрольных состояния, а не два.")]
        [Category("Поведение")]
        [Browsable(true)]
        [TypeConverter(typeof(MyBooleanConverter))]
		...
		[Browsable(false)]
        public new dynamic IndeterminateValue { get; set; }

        [Browsable(false)]
        public new dynamic FalseValue { get; set; }

        [Browsable(false)]
        public new dynamic TrueValue { get; set; }
