...
namespace osfDesigner
{
    public class DateTimePicker : System.Windows.Forms.DateTimePicker
    {
        ...
        [Description("Возвращает или задает выравнивание раскрывающегося календаря в элементе управления ПолеКалендаря (DateTimePicker).")]
        [Category("Внешний вид")]
        [Browsable(true)]
        public new LeftRightAlignment DropDownAlign
        {
            get { return (LeftRightAlignment)base.DropDownAlign; }
            set { base.DropDownAlign = (System.Windows.Forms.LeftRightAlignment)value; }
        }
        ...
        [Description("Возвращает или задает значение даты и времени, назначаемое элементу управления.")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        [Description("Возвращает или задает код для выполнения, при изменения свойства Значение (Value).")]
        [Category("Прочее")]
        [Browsable(true)]
        ...
        [Description("Возвращает или задает максимальное значение даты и времени, которое может быть выбрано в элементе управления.")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        [Description("Возвращает или задает минимальное значение даты и времени, которое может быть выбрано в элементе управления.")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        [DisplayName("ПоказатьРегулятор")]
        [Description("Возвращает или задает значение, указывающее, используется ли регулятор (также известный как элемент управления 'вверх-вниз') для изменения значения даты/времени.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        [TypeConverter(typeof(MyBooleanConverter))]
        ...
        [DisplayName("ПоказатьФлажок")]
        [Description("Возвращает или задает значение, указывающее, отображается ли флажок слева от выбранной даты.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        [TypeConverter(typeof(MyBooleanConverter))]
        ...
        [Description("Возвращает или задает строку пользовательского формата даты и времени.")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        [DisplayName("Формат")]
        [Description("Возвращает или задает формат даты и времени, отображаемых в элементе управления.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        public new FormatDateTimePicker Format
        {
            get { return (FormatDateTimePicker)base.Format; }
        ...
        [Browsable(false)]
        public new dynamic CalendarFont { get; set; }
        
        [Browsable(false)]
        public new dynamic CalendarForeColor { get; set; }
        
        [Browsable(false)]
        public new dynamic CalendarMonthBackground { get; set; }
        
        [Browsable(false)]
        public new dynamic CalendarTitleBackColor { get; set; }
        
        [Browsable(false)]
        public new dynamic CalendarTitleForeColor { get; set; }
        
        [Browsable(false)]
        public new dynamic CalendarTrailingForeColor { get; set; }
        ...
        [Browsable(false)]
        public new dynamic Checked { get; set; }
        ...
        [Browsable(false)]
        public new dynamic MaximumDateTime { get; set; }
        
        [Browsable(false)]
        public new dynamic MaximumSize { get; set; }
        
        [Browsable(false)]
        public new dynamic MinimumDateTime { get; set; }
