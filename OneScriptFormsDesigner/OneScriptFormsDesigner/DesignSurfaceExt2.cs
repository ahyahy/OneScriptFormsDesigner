...
{
    // Этот класс добавляет в экземпляр DesignSurfaceExt
    // следующие средства:
    ...
    public class DesignSurfaceExt2 : DesignSurfaceExt, IDesignSurfaceExt2
    {
        ...
        // Класс DesignSurface добавляет все свои службы в свой конструктор. Большинство этих служб можно переопределить, заменив их в свойстве
        // ServiceContainer. Чтобы заменить службу, переопределите конструктор, вызовите базовый конструктор и внесите любые изменения с помощью свойства ServiceContainer.
        private void InitServices()
        {
            ...
            if( _menuCommandService != null )
            {
                ...
                // добавьте новый IMenuCommandService
