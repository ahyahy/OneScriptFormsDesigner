...
{
    public class HProgressBar : System.Windows.Forms.ProgressBar
    {
        ...
        [Description("Возвращает или задает текущее положение индикатора выполнения.")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        [Description("Возвращает или задает наибольшее значение диапазона этого элемента управления.")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        [DisplayName("Минимум")]
        [Description("Возвращает или задает наименьшее значение диапазона этого элемента управления.")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        [Browsable(false)]
        public new dynamic MarqueeAnimationSpeed { get; set; }
        ...
        [Browsable(false)]
        public new dynamic Step { get; set; }
...
";
    ...
    public class VProgressBar : System.Windows.Forms.ProgressBar
    {
