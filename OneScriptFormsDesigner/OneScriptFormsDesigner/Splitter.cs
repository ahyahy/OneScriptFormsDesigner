...
namespace osfDesigner
{
    public class Splitter : System.Windows.Forms.Splitter
    {
        ...
        [Description("Возвращает или задает минимальное расстояние, которое должно оставаться между элементом управления Разделитель (Splitter) и краем противоположной стороны контейнера (или ближайшим элементом, присоединенным к этой стороне).")]
        [Category("Поведение")]
        [Browsable(true)]
        public new int MinExtra
        {
            get { return base.MinExtra; }
            set { base.MinExtra = value; }
        }

        [DisplayName("МинимальныйРазмер")]
        [Description("Возвращает или задает минимальное расстояние, которое должно оставаться между элементом управления Разделитель (Splitter) и краем контейнера, к которому присоединен данный элемент управления.")]
        [Category("Поведение")]
        [Browsable(true)]
