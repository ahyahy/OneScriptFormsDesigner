...
namespace osfDesigner
{
    public class TabControl : System.Windows.Forms.TabControl
    {
        ...
        [DisplayName("Вкладки")]
        [Description("Возвращает набор вкладок в этом элементе управления ПанельВкладок (TabControl).")]
        [Category("Поведение")]
        [Browsable(true)]
        ...
        {
            get { return (TabAlignment)base.Alignment; }
            set { base.Alignment = (System.Windows.Forms.TabAlignment)value; }
        }
        ...
        [Description("Возвращает или задает код для выполнения, когда ПанельВкладок.ИндексВыбранного (TabControl.SelectedIndex) изменяется.")]
        [Category("Прочее")]
        [Browsable(true)]
        ...
        [Description("Возвращает или задает значение, указывающее, будет ли отображаться более одной строки вкладки.")]
        [Category("Прочее")]
        [Browsable(true)]
        [TypeConverter(typeof(MyBooleanConverter))]
        ...
        [Description("Возвращает или задает внешний вид вкладок элемента управления.")]
        [Category("Поведение")]
        [Browsable(true)]
        public new TabAppearance Appearance
        {
            get { return (TabAppearance)base.Appearance; }
            set { base.Appearance = (System.Windows.Forms.TabAppearance)value; }
        }

        [DisplayName("ПоказатьПодсказку")]
        [Description("Возвращает или задает значение, указывающее, отображается ли всплывающая подсказка вкладки при наведении мыши на вкладку.")]
        [Category("Поведение")]
        [Browsable(true)]
        [TypeConverter(typeof(MyBooleanConverter))]
        ...
        [Description("Возвращает или задает размер вкладок элемента управления.")]
        [Category("Поведение")]
        [Browsable(true)]
        [TypeConverter(typeof(MySizeConverter))]
        [Editor(typeof(MySizeEditor), typeof(UITypeEditor))]
        ...
        [Description("Возвращает или задает способ изменения размера вкладок элемента управления.")]
        [Category("Поведение")]
        [Browsable(true)]
        public new TabSizeMode SizeMode
        {
            get { return (TabSizeMode)base.SizeMode; }
            set { base.SizeMode = (System.Windows.Forms.TabSizeMode)value; }
        }

        [DisplayName("СписокИзображений")]
        [Description("Возвращает или задает изображения, отображаемые на вкладках элемента управления.")]
        [Category("Внешний вид")]
        [Browsable(true)]
        ...
        [Browsable(false)]
        public new dynamic HotTrack { get; set; }
        ...
        [Browsable(false)]
        public new dynamic RowCount { get; set; }
        
        [Browsable(false)]
        public new dynamic Site { get; set; }
        
        [Browsable(false)]
        public new dynamic TabCount { get; set; }
